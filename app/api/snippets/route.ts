...
const snippets: Omit<snippetModel, "_id">[] = [
  ...
  },
  {
    ...
    favoriteByIds: ["randomuser5", "RegEx"],
    tags: ["HTML", "Links"],
  ...
  },
  {
    ...
    tags: ["CSS", "Headings", "Titles", "RegEx"],
    snippetCode:
      "h1 {\n  color: blue;\n  font-size: 24px;\n}\nh2 {\n  color: green;\n  font-size: 20px;\n}\nh3 {\n  color: red;\n  font-size: 16px;\n}",
  ...
  },
  {
    ...
    favoriteByIds: [],
    tags: ["JavaScript", "Variables", "MongoDb", "RegEx"],
    snippetCode:
  ...
  },
  {
    ...
    tags: ["Git", "branch", "create", "Visual Studio Code"],
  ...
  },
  {
    ...
    favoriteByIds: ["randomuser1"],
    tags: ["SQL", "SELECT", "Visual Studio Code"],
